...
class DummyNotices:
  ...
  def from_event(dummy_event, change_field:dict):
      "Replace the string in the dummy event with the ones in change_field"
      for key, value in change_field.items():
          dummy_event = dummy_event.replace(key, value)
      return textwrap.dedent(dummy_event).strip().encode('UTF-8')
  ...
  <voe:VOEvent
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    xmlns:voe="http://www.ivoa.net/xml/VOEvent/v2.0" xsi:schemaLocation="http://www.ivoa.net/xml/VOEvent/v2.0 http://www.ivoa.net/xml/VOEvent/VOEvent-v2.0.xsd" version="2.0" role="test" ivorn="ivo://gwnet/LVC#MS230414r-3-Initial">
    <Who>
      <Date>2023-04-14T18:01:45Z</Date>
      <Author>
    ...
    <What>
      ...
      <Param name="GraceID" value="MS230414r" ucd="meta.id" dataType="string">
      ...
      <Param name="EventPage" value="https://gracedb.ligo.org/superevents/MS230414r/view/" ucd="meta.ref.url" dataType="string">
      ...
      <Group name="External Coincidence" type="External Coincidence">
        <Param name="External_GCN_Notice_Id" value="1365529201" ucd="meta.id" dataType="string">
          <Description>GCN trigger ID of external event</Description>
        </Param>
        <Param name="External_Ivorn" value="ivo://lvk.internal/AGILE#MDC-test_event2023-04-14T17:39:43.669Z" ucd="meta.id" dataType="string">
        ...
        <Param name="Time_Difference" value="2.12" ucd="meta.code" dataType="float">
          <Description>Time difference between GW candidate and external event, centered on the GW candidate</Description>
        </Param>
        <Param name="Time_Coincidence_FAR" value="5.373509899366442e-18" unit="Hz" ucd="arith.rate;stat.falsealarm" dataType="float">
          <Description>Estimated coincidence false alarm rate in Hz using timing</Description>
        </Param>
        <Param name="Time_Sky_Position_Coincidence_FAR" value="2.337766627893005e-18" unit="Hz" ucd="arith.rate;stat.falsealarm" dataType="float">
          <Description>Estimated coincidence false alarm rate in Hz using timing and sky position</Description>
        </Param>
        <Param name="joint_skymap_fits" value="https://gracedb.ligo.org/api/superevents/MS230414r/files/combined-ext.multiorder.fits,1" ucd="meta.ref.url" dataType="string">
      ...
      <Group name="GW_SKYMAP" type="GW_SKYMAP">
        <Param name="skymap_fits" value="https://gracedb.ligo.org/api/superevents/MS230414r/files/bayestar.multiorder.fits,1" ucd="meta.ref.url" dataType="string">
          <Description>Sky Map FITS</Description>
        </Param>
      </Group>
      <Group name="Classification" type="Classification">
        <Param name="BNS" value="0.9999941407656829" ucd="stat.probability" dataType="float">
        ...
        <Param name="Terrestrial" value="5.859234317052256e-06" ucd="stat.probability" dataType="float">
      ...
      <ObsDataLocation>
        ...
        <ObservationLocation>
          ...
          <AstroCoords coord_system_id="UTC-FK5-GEO">
            <Time unit="s">
              <TimeInstant>
                <ISOTime>2023-04-14T17:39:41Z</ISOTime>
              </TimeInstant>
            </Time>
          </AstroCoords>
        </ObservationLocation>
    ...
    <Citations>
      <EventIVORN cite="supersedes">ivo://gwnet/LVC#MS230414r-2-Preliminary</EventIVORN>
      <EventIVORN cite="supersedes">ivo://gwnet/LVC#MS230414r-1-Preliminary</EventIVORN>
  ...
  <voe:VOEvent
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    xmlns:voe="http://www.ivoa.net/xml/VOEvent/v2.0" xsi:schemaLocation="http://www.ivoa.net/xml/VOEvent/v2.0 http://www.ivoa.net/xml/VOEvent/VOEvent-v2.0.xsd" version="2.0" role="test" ivorn="ivo://gwnet/LVC#MS230414p-1-Preliminary">
    <Who>
      <Date>2023-04-14T15:51:49Z</Date>
      <Author>
        <contactName>LIGO Scientific Collaboration, Virgo Collaboration, and KAGRA Collaboration</contactName>
      </Author>
    </Who>
    <What>
      ...
      <Param name="GraceID" value="MS230414p" ucd="meta.id" dataType="string">
        <Description>Identifier in GraceDB</Description>
      </Param>
      ...
      <Param name="EventPage" value="https://gracedb.ligo.org/superevents/MS230414p/view/" ucd="meta.ref.url" dataType="string">
        <Description>Web page for evolving status of this GW candidate</Description>
      </Param>
      <Param name="Instruments" value="H1,L1" ucd="meta.code" dataType="string">
        <Description>List of instruments used in analysis to identify this event</Description>
      ...
      <Group name="GW_SKYMAP" type="GW_SKYMAP">
        <Param name="skymap_fits" value="https://gracedb.ligo.org/api/superevents/MS230414p/files/bayestar.multiorder.fits,0" ucd="meta.ref.url" dataType="string">
          <Description>Sky Map FITS</Description>
        </Param>
      </Group>
      <Group name="Classification" type="Classification">
        <Param name="BNS" value="0.9999823128590818" ucd="stat.probability" dataType="float">
          <Description>Probability that the source is a binary neutron star merger (both objects lighter than 3 solar masses)</Description>
        </Param>
        <Param name="NSBH" value="0.0" ucd="stat.probability" dataType="float">
          <Description>Probability that the source is a neutron star-black merger (secondary lighter than 3 solar masses)</Description>
        ...
        <Param name="Terrestrial" value="1.7687140918198363e-05" ucd="stat.probability" dataType="float">
          <Description>Probability that the source is terrestrial (i.e., a background noise fluctuation or a glitch)</Description>
        </Param>
        <Description>Source classification: binary neutron star (BNS), neutron star-black hole (NSBH), binary black hole (BBH), or terrestrial (noise)</Description>
      </Group>
      ...
      <ObsDataLocation>
        ...
        <ObservationLocation>
          ...
          <AstroCoords coord_system_id="UTC-FK5-GEO">
            <Time unit="s">
              <TimeInstant>
                <ISOTime>2023-04-14T15:46:18Z</ISOTime>
              </TimeInstant>
            </Time>
          </AstroCoords>
        </ObservationLocation>
